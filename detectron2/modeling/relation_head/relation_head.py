...
class RelationHead(torch.nn.Module):
    def __init__(self, cfg, in_channels):
        ...
        self.relation_process = make_relation_module(cfg, relation_feature_dim, 'TemporalSpatial') #SpatialTemporal #TemporalSpatial #RelationModule
    ...
    def forward(self, feature, proposals, person_features,feature_bef, proposals_bef, person_features_bef,feature_aft, proposals_aft, person_features_aft):
        if self.training:
            ...
            boxes_bef, person_features_bef, person_probs_bef, gt_ranks_bef = select_from_proposals(proposals_bef, person_features_bef)
            boxes_aft, person_features_aft, person_probs_aft, gt_ranks_aft = select_from_proposals(proposals_aft, person_features_aft)
