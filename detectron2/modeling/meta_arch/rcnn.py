...
class RankSaliencyNetwork(nn.Module):
    ...
    def forward(self, batched_inputs,its=0):
        ...
        proposals_bef, proposal_losses_bef = self.proposal_generator(images_bef, features_bef, gt_instances_bef)
        proposals_aft, proposal_losses_aft = self.proposal_generator(images_aft, features_aft, gt_instances_aft)
        results, detector_losses, person_features = self.roi_heads(images, features, proposals, gt_instances)
        results_bef, detector_losses_bef, person_features_bef = self.roi_heads(images_bef, features_bef, proposals_bef, gt_instances_bef)
        results_aft, detector_losses_aft, person_features_aft = self.roi_heads(images_aft, features_aft, proposals_aft, gt_instances_aft)
